...
You can choose any of the two methods to sign up: SSO or Work Email
...
3. Under **Tell Us About You**, fill the required basic details, and click **Next** to proceed to Step 2: Install Devtron.
...
5.  Under **Tell Us About You**, fill the required basic details, and click **Next** to proceed to Step 2: Install Devtron.
...
The license is bound to your Kubernetes cluster and cannot be transferred to another cluster. In case the cluster is deleted, you will not be able to claim freemium license on a new cluster. In that case, contact support@devtron.ai.
{% endhint %}
...
Refer Step 2: Install Devtron for the installation.
