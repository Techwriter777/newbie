...
| **Data**               | <p>Write the payload content of the notification in a JSON format. Refer: <a href="broken-reference">Microsoft Teams Payload</a><br><a href="broken-reference">Discord Payload</a><br><a href="broken-reference">Slack Payload</a><br><a href="broken-reference">RingCentral Payload</a></p> |
...
{% code title="Teams Payload Example" overflow="wrap" lineNumbers="true" %}
```json
{
    "type": "message",
    "attachments": [
...
{% code title="Slack Payload Example" overflow="wrap" lineNumbers="true" %}
```json
{
    "text": "CI Triggered",
    "blocks": [
...
{% code title="Discord Payload Example" overflow="wrap" lineNumbers="true" %}
```json
{
...
{% code title="RingCentral Payload Example" overflow="wrap" lineNumbers="true" %}
```json
{
