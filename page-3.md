...
* Make sure that the FluxCD controller is installed in the cluster in which you want to deploy the application. Refer Enable GitOps Deployments with FluxCD to learn more.
